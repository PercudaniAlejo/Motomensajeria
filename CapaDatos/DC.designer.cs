...
namespace CapaDatos
{
    ...
    partial void OnnumCelularChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cliente_Envio", Storage="_eEnvio", ThisKey="id", OtherKey="idCliente")]
    ...
    partial void OnprecioFinalChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cliente_Envio", Storage="_eCliente", ThisKey="idCliente", OtherKey="id", IsForeignKey=true)]
